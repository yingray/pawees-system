...
function check_if_in_view() {
  ...
  $.each($animation_elements, function() {
    ...
    if ((element_bottom_position > window_top_position) &&
      ...
      // 進場
  	  $element.children('img').addClass('fixed_bg');
      $element.children('video').addClass('fixed_bg');
      // $element.fadeIn();
    } else {
      // 出場
      $element.children('img').removeClass('fixed_bg'); 
      $element.children('video').removeClass('fixed_bg'); 
      // $element.fadeOut();
    }
  });
}
